...
namespace Bundlingway.Utilities.Extensions
{
    public static class PostProcessorExtensions
    {
        ...
        public static void RunRawFilePipeline(this ResourcePackage package, Bundlingway.Core.Utilities.Logging _logger, IAppEnvironmentService envService)
        {
            ...
            var presetPath = Path.Combine(baseline, Bundlingway.Core.Constants.Folders.PackagePresets);
        ...
        public static Preset RunPostProcessorPipeline(this Preset preset, ResourcePackage package, IniParser.Model.IniData iniData, Bundlingway.Core.Utilities.Logging _logger, IAppEnvironmentService envService)
        {
