...
namespace Bundlingway.Core.Services
{
    public class GPosingwayService
    {
        ...
        public async Task GetLocalInfoAsync()
        {
            ...
            var c = _configService.Configuration.GPosingway;
            var gposingwayPackage = await _packageService.GetPackageByNameAsync(Constants.GPosingwayDefaultPackage(_envService).Name);
        ...
        public async Task UpdateAsync(bool force = true)
        {
            ...
            var gposingwayPackage = await _packageService.GetPackageByNameAsync(Constants.GPosingwayDefaultPackage(_envService).Name)
                ?? await _packageService.OnboardPackageAsync(Constants.GPosingwayDefaultPackage(_envService).Name);
            ...
            try
            {
                ...
                {
                    await _notificationService.AnnounceAsync($"Downloading {Constants.Files.GPosingwayConfig}...");
